...
class unet_L5_asym(nn.Module):
    def __init__(self, in_num=1, out_num=1, filters=[32,64,128,256,512], activation='sigmoid'):
        super().__init__()
...
class unet_L5_asym_sk(unet_L5_asym):
    def __init__(self, in_num=1, out_num=1, filters=[32,64,128,256,512], activation='sigmoid'):
